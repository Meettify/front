...
const MeetCard = () => {
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden w-64 mt-4">
            ...
            <div className="p-4 text-left h-47"> {/* text-left 추가 */}
                <h3 className="font-bold text-lg mb-1">모임명</h3>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="ml-auto">
                        <RoundedButton style={{ padding: '7px 15px', fontSize: '12px' }}>가입하기</RoundedButton>
                    </div>
                </div>
            </div>
        </div>
