...
const MemList = () => {
  const { allMemberLists, totalMemberListsPage, setAllMemberLists } =
    useAdminMainStore();
        ...
        setDisplayedMembers((prev) => {
          const newData = filteredData.filter(
            (newMember) =>
              !prev.some(
                (existingMember) =>
                  existingMember.memberId === newMember.memberId
              )
          );
      ...
      <div className="flex justify-end mb-4">
        <button
          className={`px-3 py-2 mx-1 rounded ${
            sortOrder === "new" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}
        ...
        <button
          className={`px-3 py-2 mx-1 rounded ${
            sortOrder === "old" ? "bg-blue-500 text-white" : "bg-gray-300"
          }`}
